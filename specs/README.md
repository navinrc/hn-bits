...
| V1.6 | Visual rework: two-line story rows, bordered comments cards, collapsed-by-default threads, tab bar + polish + loader, comments polish (colors, fold states, contacts) | **done** | [v1.6/](v1.6/01-story-row-layout.md) |
