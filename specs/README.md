...
| V1.6 | Visual rework: two-line story rows, bordered comments cards, collapsed-by-default threads, tab bar + polish + loader | in progress (phases 1–3 done, 4–6 spec'd) | [v1.6/](v1.6/01-story-row-layout.md) |
