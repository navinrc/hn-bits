...
V3.7 is feature-complete against `specs/v3.7/`. `npm test` (272 tests) and `npm run build` after implementation; both live-verified against the real Algolia endpoint (`Claude Code`, `OpenAI` queries) before and after the 1a fix.
