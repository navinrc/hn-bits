...
| 8: Navbar rule, selection bar, leaf collapse | pending | implementation of specs/v1.6/07 |
...
- V1.6 phases 1–7 complete; phase 8 (specs/v1.6/07) spec'd, implementation pending.
- Next: V1.6 phase 8, then V2 (local AI, Ollama) per `specs/v2/`.
