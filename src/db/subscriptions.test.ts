...
describe('addSubscription', () => {
  it('inserts and returns the new subscription with lastRunAt null', () => {
    ...
    expect(sub).toMatchObject({ name: 'postgres', query: 'postgres', minPoints: 50, lastRunAt: null });
...
describe('updateSubscription', () => {
  it('updates fields by id', () => {
    ...
    expect(updated).toMatchObject({ id: sub.id, name: 'pg', query: 'postgresql', minPoints: 20 });
  });
